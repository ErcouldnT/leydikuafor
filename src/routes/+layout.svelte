...
<header class="p-10">
	<div class="flex lg:flex-row flex-col justify-center items-center gap-10">
		...
		<div class="flex flex-wrap gap-5 lg:gap-10 justify-center items-center">
			...
			<a href="whatsapp://send?phone=905426873959" target="_blank" class="btn"
				>Randevu Al</a
			>
		...
		<a
			href="https://goo.gl/maps/2VRWzvpheRA5DNVo6"
			target="_blank"
			rel="noreferrer"
			class="btn gap-2"
		>
			<i class="text-2xl fa fa-map-marker" aria-hidden="true" />
			<div>Lokasyon</div>
		</a>
	</div>
</header>
...
<footer class="footer footer-center p-10 bg-base-200 text-base-content rounded">
	<div class="grid grid-flow-col gap-4">
		<a href="/hizmetler" class="link link-hover">Hizmetler</a>
		<a href="/hakkimizda" class="link link-hover">Hakkımızda</a>
		<a href="/iletisim" class="link link-hover">İletişim</a>
	</div>
	<div>
		<div class="grid grid-flow-col gap-7 text-4xl m-auto">
			...
			<a href="whatsapp://send?phone=905426873959" target="_blank" rel="noreferrer"
				><i class="fa fa-whatsapp cursor-pointer" aria-hidden="true" /></a
			>
		</div>
	</div>
	<div>
		<p class="">
			<span class="">ÖZEL İLGİYİ HAK EDİYORSUNUZ</span>
			<br />
			1991'den beri...
		</p>
	</div>
...
<footer class="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
	<div class="items-center grid-flow-col">
		...
		>
		<p>
			Giresun Leydi Kuaför
			<br />
			<a class="" href="https://erkut.dev"> &copy Erkut {new Date().getFullYear()}</a>
		</p>
	</div>
