		...
		<div class='m-auto py-5 px-2 lg:p-10'>
			...
			<div class='border rounded-xl p-5'>
				...
				<div class='py-5'>
					...
					<div class='italic'>Giresun Leydi Kuaför</div>
					<div>Şeyh Keramettin Mah.</div>
					<div>Suat Akgün Sokak</div>
					<div>No: 27 Giresun/Merkez</div>
					<div class='italic'>(Başarım Kurs Merkezi karşısı, belediye ek binası)</div>
				</div>
			</div>
		</div>
		<div class='lg:m-auto lg:order-last order-first my-5'>
			<enhanced:img class='lg:rounded-xl lg:max-w-lg' src={gelin2} alt='gelin2' loading='eager' fetchpriority='high' />
		</div>
	</div>
</main>
